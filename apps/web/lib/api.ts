...
export const api = {
  ...
  tickets: {
    list: (params?: string) => request(`/tickets${params ? `?${params}` : ""}`),
    get: (id: string) => request(`/tickets/${id}`),
    create: (body: Record<string, any>) => request("/tickets", { method: "POST", body }),
    updateStatus: (id: string, body: Record<string, any>) => request(`/tickets/${id}/status`, { method: "PATCH", body }),
    assign: (id: string, body: Record<string, any>) => request(`/tickets/${id}/assign`, { method: "PATCH", body }),
    addReply: (id: string, body: Record<string, any>) => request(`/tickets/${id}/replies`, { method: "POST", body }),
