...
import { Store02Icon, Search01Icon, CheckmarkCircle02Icon, Package02Icon, TruckIcon } from "@hugeicons/core-free-icons"
import { api } from "@/lib/api"
import { formatNumber } from "@/lib/format"
import { toast } from "sonner"

export default function SGRStationsPage() {
  ...
  return (
    <DashboardLayout breadcrumbs={[{ label: "Dashboard", href: "/dashboard" }, { label: "SGR Parcel Service", href: "/dashboard/sgr" }, { label: "Stations" }]}>
      <div className="flex flex-col gap-6 p-4 lg:p-6">
        <PageHeader
          title="SGR Stations"
          description="Rail stations and hubs for SGR parcel service"
        />
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <MetricCard
            label="Active"
            value={formatNumber(stations.filter(s => s.isActive).length)}
